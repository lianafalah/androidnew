...
public class HomeAppActivity extends AppCompatActivity
    ...
    private TextView salam, balance, username, beans, point;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        salam= (TextView)findViewById(R.id.TVsalam);
        username= (TextView)findViewById(R.id.TVusername);
        beans= (TextView)findViewById(R.id.TVbeans);
    ...
    private void loadData() {
        ...
        call.enqueue(new Callback<HomeResponse>() {
            ...
            public void onResponse(Call<HomeResponse> call, Response<HomeResponse> response) {
                Log.i("### email", "onResponse: " + response.body().email);
                Log.i("### salam", "onResponse: " + response.body().salam);
                Log.i("### username", "onResponse: " + response.body().username);
                Log.i("### primarycard", "onResponse: " + response.body().primaryCard.cardNumber);
                salam.setText(response.body().salam);
                username.setText(response.body().username);
                balance.setText(response.body().balance);
                beans.setText(response.body().beans);
            }
            @Override
